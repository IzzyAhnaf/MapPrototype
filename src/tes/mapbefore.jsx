...
const ORS_KEY = '5b3ce3597851110001cf6248be24502331b243318274ccf1d117148e';

const UserLocationMarker = ({ onLocationFound, Destination }) => {
    ...
    return (
        <>
            ...
            <div className="info-box text-black">
                <h3>Car Route</h3>
                <p>Distance: {carInfo.distance / 1000} km</p>
                <p>Duration: {formatDuration(carInfo.duration)}</p>
                <h3>Bike Route</h3>
                <p>Distance: {bikeInfo.distance / 1000} km</p>
                <p>Duration: {formatDuration(bikeInfo.duration)}</p>
            </div>
            {error && (
...
const Map = ({ onLocationFound, Destination }) => {
    ...
    return (
        <div style={{ position: 'relative' }}>
            <MapContainer center={[-6.402484, 106.794243]} zoom={13} style={{ height: Mobile ? '60vh' : '75vh', width: '100%' }}>
                ...
                />
                <UserLocationMarker onLocationFound={onLocationFound} Destination={Destination} />
            </MapContainer>
        </div>
    );
};
